                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="api_key" id="api_key"
                            value="{{ old('api_key', $client->api_key) }}" required
                    ...
                    <div>
                        <label for="api_base_url" class="block text-sm font-medium text-slate-700 mb-1">API Base
                            URL</label>
                        <input type="url" name="api_base_url" id="api_base_url"
                            value="{{ old('api_base_url', $client->api_base_url) }}"
                            class="w-full rounded-lg border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                        @error('api_base_url')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
